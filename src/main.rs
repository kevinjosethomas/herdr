...
# rename_workspace = ["prefix+shift+w", "prefix+ctrl+r"]
...
# [ui.sidebar.agents]
# Show the agents section in the expanded sidebar. Set false to hide the agents
# header, rows, and empty state; the spaces section then fills the sidebar height.
# enabled = true
